...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
            ...
            for j in range(cell[1] - 1, cell[1] + 2):
                ...
                if 0 <= i < self.height and 0 <= j < self.width:
                    if neighbour in self.mines:
                        # Important! If one of the neighbouring cells is a mine decrease the count of mines
                        count -= 1
                        continue
        ...
        for i in self.knowledge.copy():
            ...
            if i.cells == new_sen.cells:
                continue
                
            if i.cells < new_sen.cells:
                self.knowledge.append(Sentence(new_sen.cells - i.cells, new_sen.count - i.count))
